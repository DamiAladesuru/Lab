...
path = "~/Documents/DataAnalysis/Niedersachsen/final"
...
for category_name, df in cat_yearlies.items():
    ...
    save_path = f"reports/figures/{category_name}_trends.svg"
...
pm.multiline_metrics_with_shared_legend(
    ...
    ylabel="Aggregate Change (%) in Field Metric Value from 2012",
    metrics=metrics,
    save_path="reports/figures/allcat_trends_shared_legend.svg",
    color_mapping=color_mapping,
    format='svg'
)
