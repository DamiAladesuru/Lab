...
################################################################################
# plot the aggregate study area trend of change in field metric values over time
################################################################################
...
metrics = {
    ...
    'Median CPAR': 'medcpar_percdiffy1_med',
...
pm.multiline_metrics(
    df=multiline_df,
    title="Trend of Change in Field Metric Values Over Time",
...
################################################################################
# grid disaggreated trend of change in field metric values over time
################################################################################
...
################################################################################
# FiSC metric for particular crops
################################################################################
